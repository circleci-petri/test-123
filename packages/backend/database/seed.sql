...
INSERT INTO users (username, email, password_hash, is_premium) VALUES
  ('admin', 'admin@example.com', '$2b$10$abcdefghijklmnopqrstuv', 1),
  ('alice', 'alice@example.com', '$2b$10$abcdefghijklmnopqrstuv', 1),
  ('bob', 'bob@example.com', '$2b$10$abcdefghijklmnopqrstuv', 0),
  ('charlie', 'charlie@example.com', '$2b$10$abcdefghijklmnopqrstuv', 0);
